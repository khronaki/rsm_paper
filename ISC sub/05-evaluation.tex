...
\caption{Speedup of {\proposal} compared to the speedup of Baseline and Baseline+RTopt for each application for systems with 8 up to 512 cores. The average results of \ref{fig:speedup_homo1} show the average among all workloads shown on \ref{fig:speedup_homo1} and \ref{fig:speedup_homo2}}
\end{figure*}
