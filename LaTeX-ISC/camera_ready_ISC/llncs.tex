...
%
\begin{document}
\title{TaskGenX: A Hardware-Software Proposal \\for Accelerating Task Parallelism}
...
% 
\author{Kallia Chronaki$^\ast$, Marc Casas$^\ast$, Miquel Moreto$^\ast$, \\Jaume Bosch$^\ast$, Rosa M. Badia$^\ast\dag$}
\institute{$\ast$Barcelona Supercomputing Center, \\$\dag$Artificial Intelligence
Research Institute (IIIA) - \\Spanish National Research Council
(CSIC)\\ -\\
\textit{Email: \{kallia.chronaki, marc.casas, miquel.moreto, \\jaume.bosch, rosa.m.badia\}@bsc.es}
}
